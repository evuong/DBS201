--Names
--Jonathan Mani (123280182)
--Edward Vuong (120246186)
--Giuse Bellissimo (121143184)
--Md Nabid Bin Azad (146836176)


--DBS Final Assignment

CREATE SCHEMA DR201ABP;
SET SCHEMA DR201ABP;

REVOKE ALL ON SCHEMA DR201ABP FROM PUBLIC;	

GRANT ALL ON SCHEMA DR201ABP TO MC201B40;
GRANT ALL ON SCHEMA DR201ABP TO MC201B04;
GRANT ALL ON SCHEMA DR201ABP TO MC201A12;
GRANT ALL ON SCHEMA DR201ABP TO MC201A06;
